...
<main id="site-content">
    ...
    $soap_query = new WP_Query($args);

    if ($soap_query->have_posts()) :
        while ($soap_query->have_posts()) : $soap_query->the_post();
            ...
            echo '<ul>';
            $relatedIngredients = get_field('related_ingredient_soap');
            ...
            echo '<ul>';
            $relatedFragrances = get_field('related_fragrance_soap');
        ...
        echo paginate_links(array(
            'total' => $soap_query->max_num_pages,
            'current' => $paged,
